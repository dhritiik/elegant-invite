...
import heroBackground from "/hero-wedding2.jpg";
import logo from "/logo-wedding2.png";
import EventTimeline from "./EventTimeline";
import { useEffect, useState, useRef } from "react";
import { AmbientBackground, ThemeType } from "./AmbientBackground";

const InvitationCard = ({ isVisible }: { isVisible: boolean }) => {
    ...
    <>
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center pb-20 md:pb-24 pt-10">
          ...
          >
            {/* The gradient ovconst baseerlay div has been removed here */}
          </div>
          ...
          >
            ...
            >
              <img
                src={logo}
                alt="P&R Wedding Logo"
                className="w-64 h-64 md:w-[28rem] md:h-[28rem] object-contain mx-auto drop-shadow-lg"
              />
            </motion.div>
            ...
            >
              {/* Priya & Rahul Combined with smaller Ampersand */}
              <motion.h1
              ...
              >
                {/* Name Size */}
                <span className="text-6xl md:text-8xl lg:text-[9rem]">Priya </span>

                {/* Ampersand Size (Smaller) */}
                <span className="text-4xl md:text-6xl lg:text-[6rem] px-2"> &  </span>

                {/* Name Size */}
                <span className="text-6xl md:text-8xl lg:text-[9rem]"> Rahul </span>
              </motion.h1>
            ...
            >
              ...
              >
                ...
                <span className="block font-bold">
                  Smt. Urmilaben Rameshchandra Mehta & Family
                </span>
              ...
              >
                <p className="font-body font-black text-base md:text-base uppercase tracking-wide mb-1">
                  (D/O Smt. Bhavnaben & Shri Rajeshbhai Mehta)
                </p>
                ...
                <p className="font-body font-black text-base md:text-base uppercase tracking-wide mt-2 mb-2">
                  (S/O Smt. Kirtiben & Shri Dilipbhai Desai)
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="font-display text-gold text-lg md:text-base font-bold">
                  <span className="block">smt. bhavna rajesh mehta</span>
                  <span className="block">smt. sonal kirit desai</span>
                  <span className="block mb-3">smt. arti kamlesh mehta</span>
                </p>

                <p className="font-display text-sage-dark text-sm mb-1">With Love</p>
                <p className="font-display text-gold text-lg md:text-base font-bold">
                  <span className="block">arjun - rohan - neha </span>
                </p>
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          <div className="container max-w-4xl mx-auto px-6 relative z-10">
            <div className="text-center mb-2">
              <h2 className={`font-display text-3xl md:text-5xl mb-2 transition-colors duration-500 ${currentTheme === 'reception' ? 'text-black' : 'text-foreground'}`}>
                the celebration
              </h2>
            </div>
        ...
        <footer className="bg-sage pt-4 pb-12 md:pt-6 md:pb-16 relative overflow-hidden">
          <div className="text-center relative z-10 flex flex-col items-center">
            ...
            <img
              src={logo}
              alt="P & R Logo"
              className="w-56 h-56 md:w-80 md:h-80 object-contain mb-4 opacity-90 drop-shadow-md"
            />
            <p className="font-body text-cream-light/70 text-sm">Priya & Rahul</p>
          </div>
        </footer>
      </motion.div>
    </>
