...
const events: TimelineEvent[] = [
  {
    ...
    description: "Join us for an evening of celebration, dinner, and dancing as we commemorate 50 years of love and togetherness.",
    venue: "Grand Ballroom, The Taj Mahal Palace, Mumbai",
    style: "vertical",
    image: "/anni-party.jpg",
