...
import heroBackground from "/hero-anni.jpg";
import logo from "/logo-anni.png"; 
    ...
    >
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pb-20 md:pb-24 pt-10">
        ...
        >
          ...
          >
            {/* Ayesha & Vikram Combined with smaller Ampersand */}
            <motion.h1 
              className="font-imperial text-gold mb-0 tracking-wide leading-none [text-shadow:0.5px_0_0_currentColor]"
              animate={{ 
                textShadow: [
            ...
            >
              <span className="text-6xl md:text-8xl lg:text-[9rem]">Ayesha </span>
              <span className="text-4xl md:text-6xl lg:text-[6rem] px-2"> &  </span>
              <span className="text-6xl md:text-8xl lg:text-[9rem]"> Vikram </span>
            </motion.h1>
        ...
        <div className="container max-w-3xl mx-auto px-2 text-center relative z-10">
          ...
          >
            ...
            <p className="font-body text-xl md:text-2xl text-black leading-relaxed mb-3 max-w-xl mx-auto italic">
              to grace the 50th Anniversary Celebration of
            </p>
            ...
            >
              <p className="font-display text-sage-dark text-sm mb-1">Looking forward to seeing you</p>
              <p className="font-display text-gold text-lg md:text-base font-bold">
                <span className="block">The Grandchildren</span>
              </p>
      ...
      <footer className="bg-sage pt-4 pb-12 md:pt-6 md:pb-16 relative overflow-hidden">
        <div className="text-center relative z-10 flex flex-col items-center">
          ...
          />
          <p className="font-body text-cream-light/70 text-sm">Ayesha & Vikram</p>
        </div>
      </footer>
    </motion.div>
    </>
